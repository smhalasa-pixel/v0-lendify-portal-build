...
import { renderInfractionEmail, type InfractionEmailData } from '@/lib/email-templates'

interface RequestBody extends InfractionEmailData {
...
export async function POST(request: Request) {
  ...
  const { subject, html, text } = renderInfractionEmail(body)

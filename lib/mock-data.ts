...
// Scorecard Templates for 3 Role Types: Opener, Closer, Account Manager
export const mockScorecardTemplates: ScorecardTemplate[] = [
  // ========== OPENER QUALITY EVALUATION ==========
  {
    id: 'scorecard-opener-1',
    name: 'Opener Quality Evaluation v2.1',
    description: 'Standard evaluation template for Opener agents handling initial client contact and qualification',
    type: 'opener',
    version: 2,
    isActive: true,
    ...
    categories: [
      { category: 'opening', weight: 25, criteria: ['op-1', 'op-2', 'op-3', 'op-4'] },
      { category: 'discovery', weight: 30, criteria: ['op-5', 'op-6', 'op-7', 'op-8'] },
      { category: 'presentation', weight: 15, criteria: ['op-9', 'op-10'] },
      { category: 'compliance', weight: 20, criteria: ['op-11', 'op-12', 'op-13'] },
      { category: 'professionalism', weight: 10, criteria: ['op-14', 'op-15'] },
    ],
    criteria: [
      // Opening (25%)
      { id: 'op-1', name: 'Professional Greeting', description: 'Used proper greeting with name and company identification', category: 'opening', maxPoints: 10, weight: 6, isRequired: false, isCritical: false },
      { id: 'op-2', name: 'Verified Client Identity', description: 'Properly verified client identity using security questions', category: 'opening', maxPoints: 10, weight: 7, isRequired: true, isCritical: true },
      { id: 'op-3', name: 'Stated Purpose of Call', description: 'Clearly stated the reason for the call', category: 'opening', maxPoints: 10, weight: 6, isRequired: false, isCritical: false },
      { id: 'op-4', name: 'Permission to Continue', description: 'Asked for permission to proceed with the conversation', category: 'opening', maxPoints: 10, weight: 6, isRequired: false, isCritical: false },
      // Discovery (30%)
      { id: 'op-5', name: 'Financial Situation Assessment', description: 'Properly assessed client financial situation and debt level', category: 'discovery', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      { id: 'op-6', name: 'Pain Point Identification', description: 'Identified primary pain points and motivation for seeking help', category: 'discovery', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      { id: 'op-7', name: 'Qualification Questions', description: 'Asked all required qualification questions', category: 'discovery', maxPoints: 10, weight: 7, isRequired: true, isCritical: false },
      { id: 'op-8', name: 'Active Listening', description: 'Demonstrated active listening and acknowledged client concerns', category: 'discovery', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      // Presentation (15%)
      { id: 'op-9', name: 'Program Overview', description: 'Provided clear overview of the debt relief program', category: 'presentation', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      { id: 'op-10', name: 'Set Expectations for Transfer', description: 'Properly set expectations for transfer to Closer', category: 'presentation', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      // Compliance (20%)
      { id: 'op-11', name: 'Required Disclosures', description: 'Made all required legal disclosures', category: 'compliance', maxPoints: 10, weight: 7, isRequired: true, isCritical: true },
      { id: 'op-12', name: 'No False Promises', description: 'Did not make any false promises or guarantees', category: 'compliance', maxPoints: 10, weight: 7, isRequired: true, isCritical: true },
      { id: 'op-13', name: 'Recording Consent', description: 'Obtained proper consent for call recording', category: 'compliance', maxPoints: 10, weight: 6, isRequired: true, isCritical: true },
      // Professionalism (10%)
      { id: 'op-14', name: 'Professional Tone', description: 'Maintained professional and courteous tone throughout', category: 'professionalism', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
      { id: 'op-15', name: 'Empathy & Rapport', description: 'Showed genuine empathy and built rapport with client', category: 'professionalism', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
    ],
  },
  
  // ========== CLOSER QUALITY EVALUATION ==========
  {
    id: 'scorecard-closer-1',
    name: 'Closer Quality Evaluation v3.0',
    description: 'Evaluation template for Closer agents handling final enrollment and closing the sale',
    type: 'closer',
    version: 3,
    isActive: true,
    createdById: 'user-qa-senior',
    ...
    passingScore: 75,
    autoFailThreshold: 55,
    categories: [
      { category: 'opening', weight: 10, criteria: ['cl-1', 'cl-2'] },
      { category: 'presentation', weight: 25, criteria: ['cl-3', 'cl-4', 'cl-5', 'cl-6'] },
      { category: 'objection_handling', weight: 20, criteria: ['cl-7', 'cl-8', 'cl-9'] },
      { category: 'closing', weight: 25, criteria: ['cl-10', 'cl-11', 'cl-12'] },
      { category: 'compliance', weight: 15, criteria: ['cl-13', 'cl-14', 'cl-15'] },
      { category: 'professionalism', weight: 5, criteria: ['cl-16'] },
    ],
    criteria: [
      // Opening (10%)
      { id: 'cl-1', name: 'Warm Transfer Acknowledgment', description: 'Acknowledged transfer and client name correctly', category: 'opening', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
      { id: 'cl-2', name: 'Recap of Situation', description: 'Recapped client situation from opener notes', category: 'opening', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
      // Presentation (25%)
      { id: 'cl-3', name: 'Program Details', description: 'Explained program details thoroughly and accurately', category: 'presentation', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      { id: 'cl-4', name: 'Payment Plan Explanation', description: 'Clearly explained payment plan and timeline', category: 'presentation', maxPoints: 10, weight: 6, isRequired: true, isCritical: false },
      { id: 'cl-5', name: 'Benefits Articulation', description: 'Articulated clear benefits tailored to client needs', category: 'presentation', maxPoints: 10, weight: 6, isRequired: false, isCritical: false },
      { id: 'cl-6', name: 'Fee Structure Transparency', description: 'Explained fee structure clearly and honestly', category: 'presentation', maxPoints: 10, weight: 6, isRequired: true, isCritical: true },
      // Objection Handling (20%)
      { id: 'cl-7', name: 'Acknowledged Concerns', description: 'Acknowledged and validated client concerns', category: 'objection_handling', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      { id: 'cl-8', name: 'Effective Rebuttals', description: 'Provided effective and compliant rebuttals', category: 'objection_handling', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      { id: 'cl-9', name: 'Urgency Creation', description: 'Created appropriate urgency without pressure tactics', category: 'objection_handling', maxPoints: 10, weight: 6, isRequired: false, isCritical: true },
      // Closing (25%)
      { id: 'cl-10', name: 'Asked for Commitment', description: 'Made a clear ask for enrollment commitment', category: 'closing', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      { id: 'cl-11', name: 'Payment Collection', description: 'Collected payment information correctly and securely', category: 'closing', maxPoints: 10, weight: 9, isRequired: true, isCritical: true },
      { id: 'cl-12', name: 'Enrollment Confirmation', description: 'Confirmed enrollment details and next steps', category: 'closing', maxPoints: 10, weight: 8, isRequired: true, isCritical: false },
      // Compliance (15%)
      { id: 'cl-13', name: 'TSR Compliance', description: 'Followed all TSR (Telemarketing Sales Rule) requirements', category: 'compliance', maxPoints: 10, weight: 5, isRequired: true, isCritical: true },
      { id: 'cl-14', name: 'Cancellation Policy', description: 'Explained cancellation policy clearly', category: 'compliance', maxPoints: 10, weight: 5, isRequired: true, isCritical: true },
      { id: 'cl-15', name: 'No Misleading Claims', description: 'Did not make misleading claims about results', category: 'compliance', maxPoints: 10, weight: 5, isRequired: true, isCritical: true },
      // Professionalism (5%)
      { id: 'cl-16', name: 'Professional Demeanor', description: 'Maintained professional demeanor throughout', category: 'professionalism', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
    ],
  },
  ...
  {
    id: 'scorecard-am-1',
    name: 'Lendify Account Manager Quality Evaluation v1.5',
    description: 'Evaluation template for Account Managers handling ongoing client relationships and retention',
    ...
    passingScore: 80,
    autoFailThreshold: 60,
    categories: [
      { category: 'opening', weight: 10, criteria: ['am-1', 'am-2'] },
      { category: 'discovery', weight: 20, criteria: ['am-3', 'am-4', 'am-5'] },
      { category: 'presentation', weight: 25, criteria: ['am-6', 'am-7', 'am-8'] },
      { category: 'objection_handling', weight: 15, criteria: ['am-9', 'am-10'] },
      { category: 'closing', weight: 15, criteria: ['am-11', 'am-12'] },
      { category: 'compliance', weight: 10, criteria: ['am-13', 'am-14'] },
      { category: 'professionalism', weight: 5, criteria: ['am-15'] },
    ],
    criteria: [
      // Opening (10%)
      { id: 'am-1', name: 'Client Recognition', description: 'Recognized client and referenced account history', category: 'opening', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
      { id: 'am-2', name: 'Purpose Setting', description: 'Set clear purpose for the call/interaction', category: 'opening', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
      // Discovery (20%)
      { id: 'am-3', name: 'Account Status Review', description: 'Reviewed current account status and progress', category: 'discovery', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      { id: 'am-4', name: 'Client Concerns', description: 'Proactively asked about and addressed concerns', category: 'discovery', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      { id: 'am-5', name: 'Life Changes Check', description: 'Asked about any changes in financial situation', category: 'discovery', maxPoints: 10, weight: 6, isRequired: false, isCritical: false },
      // Presentation (25%)
      { id: 'am-6', name: 'Progress Update', description: 'Provided clear update on settlement progress', category: 'presentation', maxPoints: 10, weight: 8, isRequired: true, isCritical: false },
      { id: 'am-7', name: 'Timeline Communication', description: 'Communicated realistic timeline and expectations', category: 'presentation', maxPoints: 10, weight: 9, isRequired: true, isCritical: false },
      { id: 'am-8', name: 'Value Reinforcement', description: 'Reinforced value of the program and progress made', category: 'presentation', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      // Objection Handling (15%)
      { id: 'am-9', name: 'Retention Skills', description: 'Effectively handled retention objections if applicable', category: 'objection_handling', maxPoints: 10, weight: 8, isRequired: false, isCritical: false },
      { id: 'am-10', name: 'Escalation Handling', description: 'Properly handled or escalated complex issues', category: 'objection_handling', maxPoints: 10, weight: 7, isRequired: false, isCritical: true },
      // Closing (15%)
      { id: 'am-11', name: 'Next Steps Confirmation', description: 'Confirmed clear next steps with client', category: 'closing', maxPoints: 10, weight: 8, isRequired: true, isCritical: false },
      { id: 'am-12', name: 'Follow-Up Scheduling', description: 'Scheduled appropriate follow-up if needed', category: 'closing', maxPoints: 10, weight: 7, isRequired: false, isCritical: false },
      // Compliance (10%)
      { id: 'am-13', name: 'Accurate Information', description: 'Provided accurate account and settlement information', category: 'compliance', maxPoints: 10, weight: 5, isRequired: true, isCritical: true },
      { id: 'am-14', name: 'Documentation', description: 'Properly documented call notes and actions', category: 'compliance', maxPoints: 10, weight: 5, isRequired: true, isCritical: false },
      // Professionalism (5%)
      { id: 'am-15', name: 'Client Care', description: 'Demonstrated genuine care for client success', category: 'professionalism', maxPoints: 10, weight: 5, isRequired: false, isCritical: false },
    ],
  },
]
...
export const mockEvaluations: QAEvaluation[] = [
  ...
  {
    id: 'eval-1',
    scorecardTemplateId: 'scorecard-opener-1',
    scorecardTemplateName: 'Opener Quality Evaluation v2.1',
    agentId: 'user-1',
    agentName: 'Sarah Johnson',
    agentTeamId: 'team-1',
    ...
    scores: [
      { criterionId: 'op-1', score: 9, passed: true },
      { criterionId: 'op-2', score: 10, passed: true },
      { criterionId: 'op-3', score: 8, passed: true },
      { criterionId: 'op-4', score: 9, passed: true },
      { criterionId: 'op-5', score: 10, passed: true },
      { criterionId: 'op-6', score: 8, passed: true },
      { criterionId: 'op-7', score: 9, passed: true },
      { criterionId: 'op-8', score: 9, passed: true },
      { criterionId: 'op-9', score: 8, passed: true },
      { criterionId: 'op-10', score: 7, passed: true },
      { criterionId: 'op-11', score: 10, passed: true },
      { criterionId: 'op-12', score: 10, passed: true },
      { criterionId: 'op-13', score: 10, passed: true },
      { criterionId: 'op-14', score: 9, passed: true },
      { criterionId: 'op-15', score: 8, passed: true },
    ],
    totalScore: 88,
    grade: 'B+',
    passed: true,
    hasAutoFail: false,
    strengths: ['Excellent identity verification', 'Strong discovery questioning', 'Great compliance adherence'],
    areasForImprovement: ['Could set clearer call agenda', 'Improve transfer expectation setting'],
    coachingNotes: 'Sarah continues to perform well as an Opener. Focus on setting expectations for transfer in next coaching session.',
    actionItems: ['Review transfer scripts', 'Practice agenda setting'],
    status: 'acknowledged',
  ...
  {
    id: 'eval-2',
    scorecardTemplateId: 'scorecard-closer-1',
    scorecardTemplateName: 'Closer Quality Evaluation v3.0',
    agentId: 'user-4',
    agentName: 'David Williams',
    agentTeamId: 'team-1',
    agentTeamName: 'West Coast Team',
    ...
    scores: [
      { criterionId: 'cl-1', score: 10, passed: true },
      { criterionId: 'cl-2', score: 10, passed: true },
      { criterionId: 'cl-3', score: 9, passed: true },
      { criterionId: 'cl-4', score: 10, passed: true },
      { criterionId: 'cl-5', score: 9, passed: true },
      { criterionId: 'cl-6', score: 10, passed: true },
      { criterionId: 'cl-7', score: 10, passed: true },
      { criterionId: 'cl-8', score: 9, passed: true },
      { criterionId: 'cl-9', score: 8, passed: true },
      { criterionId: 'cl-10', score: 10, passed: true },
      { criterionId: 'cl-11', score: 10, passed: true },
      { criterionId: 'cl-12', score: 9, passed: true },
      { criterionId: 'cl-13', score: 10, passed: true },
      { criterionId: 'cl-14', score: 10, passed: true },
      { criterionId: 'cl-15', score: 10, passed: true },
      { criterionId: 'cl-16', score: 10, passed: true },
    ],
    totalScore: 95,
    grade: 'A',
    passed: true,
  ...
  // Account Manager Evaluations
  {
    id: 'eval-3',
    scorecardTemplateId: 'scorecard-am-1',
    scorecardTemplateName: 'Lendify Account Manager Quality Evaluation v1.5',
    agentId: 'user-5',
    agentName: 'Emily Brown',
    agentTeamId: 'team-2',
    ...
    scores: [
      { criterionId: 'am-1', score: 7, passed: true },
      { criterionId: 'am-2', score: 8, passed: true },
      { criterionId: 'am-3', score: 6, passed: true, notes: 'Could have reviewed account more thoroughly' },
      { criterionId: 'am-4', score: 7, passed: true },
      { criterionId: 'am-5', score: 6, passed: true },
      { criterionId: 'am-6', score: 8, passed: true },
      { criterionId: 'am-7', score: 7, passed: true },
      { criterionId: 'am-8', score: 6, passed: true },
      { criterionId: 'am-9', score: 5, passed: true, notes: 'Struggled with retention objection' },
      { criterionId: 'am-10', score: 6, passed: true },
      { criterionId: 'am-11', score: 7, passed: true },
      { criterionId: 'am-12', score: 6, passed: true },
      { criterionId: 'am-13', score: 10, passed: true },
      { criterionId: 'am-14', score: 8, passed: true },
      { criterionId: 'am-15', score: 7, passed: true },
    ],
    totalScore: 71,
    grade: 'C',
    passed: false,
    hasAutoFail: false,
    strengths: ['Accurate account information provided', 'Good documentation'],
    areasForImprovement: ['Needs work on retention skills', 'Should reinforce program value better', 'Follow-up scheduling needs improvement'],
    coachingNotes: 'Schedule coaching session to review retention techniques. Emily struggles with clients questioning program value.',
    actionItems: ['Complete retention skills module', 'Shadow senior AM calls', 'Role play value reinforcement'],
    status: 'disputed',
    disputeReason: 'I believe the retention score should be higher as the client ultimately stayed enrolled.',
    createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    updatedAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(),
    submittedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
  },
  // Additional Opener Evaluation with Red Flag
  {
    id: 'eval-4',
    scorecardTemplateId: 'scorecard-opener-1',
    scorecardTemplateName: 'Opener Quality Evaluation v2.1',
    ...
    evaluatorName: 'Lisa Chen',
    evaluatorRole: 'qa_trainer',
    callId: 'CALL-2024-001298',
    callDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    callDuration: 512,
    callType: 'outbound',
    clientName: 'Jennifer Adams',
    scores: [
      { criterionId: 'op-1', score: 8, passed: true },
      { criterionId: 'op-2', score: 0, passed: false, notes: 'RED FLAG: Failed to verify client identity' },
      { criterionId: 'op-3', score: 7, passed: true },
      { criterionId: 'op-4', score: 8, passed: true },
      { criterionId: 'op-5', score: 9, passed: true },
      { criterionId: 'op-6', score: 8, passed: true },
      { criterionId: 'op-7', score: 9, passed: true },
      { criterionId: 'op-8', score: 8, passed: true },
      { criterionId: 'op-9', score: 7, passed: true },
      { criterionId: 'op-10', score: 8, passed: true },
      { criterionId: 'op-11', score: 10, passed: true },
      { criterionId: 'op-12', score: 10, passed: true },
      { criterionId: 'op-13', score: 10, passed: true },
      { criterionId: 'op-14', score: 9, passed: true },
    ...
    passed: false,
    hasAutoFail: true,
    autoFailReason: 'Failed required criterion: Verified Client Identity (op-2)',
    strengths: ['Good discovery skills', 'Strong compliance on disclosures'],
    areasForImprovement: ['CRITICAL: Must verify client identity on EVERY call', 'Review security protocols immediately'],
    coachingNotes: 'URGENT: Mike failed to verify client identity which is an auto-fail and compliance violation. Immediate coaching required.',
    actionItems: ['Complete security compliance training', 'Review with supervisor', 'Shadow 5 calls focusing on verification'],
    status: 'submitted',
    createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    updatedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    submittedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
  },
  // Closer Evaluation with below threshold auto-fail
  {
    id: 'eval-5',
    scorecardTemplateId: 'scorecard-closer-1',
    scorecardTemplateName: 'Closer Quality Evaluation v3.0',
    ...
    evaluatorName: 'Marcus Rodriguez',
    evaluatorRole: 'qa_senior',
    callId: 'CALL-2024-001301',
    callDate: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(),
    callDuration: 1823,
    callType: 'transfer',
    clientName: 'William Thompson',
    scores: [
      { criterionId: 'cl-1', score: 6, passed: true },
      { criterionId: 'cl-2', score: 5, passed: true },
      { criterionId: 'cl-3', score: 4, passed: true, notes: 'Incomplete program explanation' },
      { criterionId: 'cl-4', score: 5, passed: true },
      { criterionId: 'cl-5', score: 4, passed: true },
      { criterionId: 'cl-6', score: 3, passed: false, notes: 'RED FLAG: Did not explain fees clearly' },
      { criterionId: 'cl-7', score: 5, passed: true },
      { criterionId: 'cl-8', score: 4, passed: true },
      { criterionId: 'cl-9', score: 3, passed: false, notes: 'Used inappropriate pressure tactics' },
      { criterionId: 'cl-10', score: 5, passed: true },
      { criterionId: 'cl-11', score: 6, passed: true },
      { criterionId: 'cl-12', score: 5, passed: true },
      { criterionId: 'cl-13', score: 8, passed: true },
      { criterionId: 'cl-14', score: 7, passed: true },
      { criterionId: 'cl-15', score: 8, passed: true },
      { criterionId: 'cl-16', score: 6, passed: true },
    ],
    totalScore: 52,
    grade: 'F',
    passed: false,
    hasAutoFail: true,
    autoFailReason: 'Score below auto-fail threshold (55%) and failed critical criteria',
    strengths: ['TSR compliance was adequate'],
    areasForImprovement: ['CRITICAL: Fee transparency is required', 'Do NOT use pressure tactics', 'Presentation skills need significant work'],
    coachingNotes: 'Multiple red flags on this call. Jessica needs immediate retraining on presentation and compliance. Consider probationary status.',
    actionItems: ['Complete ethics and compliance retraining', 'Review all closing scripts', 'Manager ride-along for next 10 calls'],
    status: 'acknowledged',
